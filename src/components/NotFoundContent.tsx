...
export default function NotFoundContent() {
  return (
    <div className="min-h-[70vh] bg-steel-100 flex items-center justify-center py-16 px-6">
      <div className="max-w-xl w-full bg-white border border-steel-300 rounded-2xl p-8 sm:p-12 text-center relative overflow-hidden">
        ...
        <div className="text-left">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            <Link
              href="/"
              className="flex items-center justify-between p-3 rounded-xl border border-steel-200 hover:border-copper-500 hover:bg-copper-500/5 transition-all group"
            >
